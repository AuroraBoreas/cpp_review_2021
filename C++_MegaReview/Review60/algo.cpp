...
{
    std::vector<int> v{2,1,3,88,66,99,0,-1,99};
...
void cy::algo_mover(void)
{
    ...
    cy::print("std::move_backward, v-> ", v);
...
void cy::algo_query_value(void)
{
    ...
    cy::print("std::accumulate, rv-> ", v);

    std::vector<int> u{2,1,3,88,66,99,0,-1,99};
...
void cy::algo_query_property(void)
{
    ...
    cy::oformat("std::lexicographic_compare, rv-> ");
    std::cout << std::boolalpha << r << std::endl;
