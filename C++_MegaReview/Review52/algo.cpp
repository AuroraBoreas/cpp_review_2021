...
void TS::algo_query_property(void)
{
    ...
    auto [mi, ma] = std::minmax_element(v.begin(), v.end(), std::greater<>{});
    ...
    TS::oformat("std::binary_search, v-> ");
    ...
    auto [im, am] = std::mismatch(n.begin(), n.end(), std::begin(m));
    TS::oformat("std::mismatch, begin|end-> ");
...
void TS::algo_secret_rune(void)
{
     ...
     * *_copy;
    */
    TS::oformat("std::secrete_rune, -> nothing special;\n");
};
...
void TS::algo_lone_island(void)
{
    ...
    */
    ...
    std::transform(v.begin(), v.end(), std::ostream_iterator<int>(std::cout, " "), [](const auto& e)->int{ return e*e; });
    TS::newline();
};
